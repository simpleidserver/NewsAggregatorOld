...
export const startAddFeed = createAction("[Feeds] START_ADD_FEED", props<{ feedTitle: string, datasource: string }>());
export const errorAddFeed = createAction("[Feeds] ERROR_ADD_FEED");
export const completeAddFeed = createAction("[Feeds] COMPLETE_ADD_FEED", props<{ content: Feed }>());
