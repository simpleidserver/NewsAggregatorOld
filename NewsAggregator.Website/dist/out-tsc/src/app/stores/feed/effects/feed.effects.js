    ...
    constructor(actions$, feedService) {
        ...
        this.deleteDatasources$ = this.actions$
            ...
            return this.feedService.deleteDatasources(evt.parameters)
                .pipe(map(() => completeDeleteDatasources({ parameters: evt.parameters })), catchError(() => of(errorDeleteDatasources())));
        }));
        ...
        this.addFeed$ = this.actions$
            ...
            return this.feedService.addFeed(evt.feedTitle, evt.datasource)
                .pipe(map((feed) => completeAddFeed({ content: feed })), catchError(() => of(errorAddFeed())));
        }));
